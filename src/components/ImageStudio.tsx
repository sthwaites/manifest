...
export function ImageStudio({ products, sandboxWindow }: ImageStudioProps) {
  ...
  const [context, setContext] = useState(selectedProduct?.imagePromptHint ?? "")
  ...
  useEffect(() => {
    ...
    setContext(selectedProduct.imagePromptHint)
        ...
        <div className="space-y-4">
          ...
          <label className="block space-y-2">
            ...
            <textarea
              ...
              rows={3}
              className="w-full resize-none rounded-md border border-zinc-700 bg-zinc-950 px-3 py-2 text-sm leading-5 text-zinc-50 outline-none transition placeholder:text-zinc-500 focus:border-indigo-500"
